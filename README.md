...
```sh
pip install git+https://github.com/GIT_USER_ID/enhance-python-client.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/GIT_USER_ID/enhance-python-client.git`)
