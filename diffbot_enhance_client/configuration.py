...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of diffbot_enhance_client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = diffbot_enhance_client.Configuration(
    ...
    Note you can use the constants defined in the diffbot_enhance_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = diffbot_enhance_client.Configuration(
        signing_info = diffbot_enhance_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://kg.diffbot.com",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("diffbot_enhance_client")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: 1.0.0-rc.04".\
